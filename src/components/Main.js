        ...
        return (
            <div style={{width: "100%"}} >
              {dz === 0 ? <div style={{ width: "100%", height: "100vh", backgroundColor:"#625a52"}}>
                  ...
                  {/*<a href="/"><img src={"./slides/play.png"} alt="btn" name={13} className="main-button" style={{marginTop: "24%" ,left:"2%", width:"10%"}} /></a>*/}
                  {/*<a href="/"><img src={"./slides/play.png"} alt="btn" name={14} className="main-button" style={{marginTop: "24%" ,left:"14%", width:"10%"}} /></a>*/}
                  {/*<a href="/"><img src={"./slides/play.png"} alt="btn" name={15} className="main-button" style={{marginTop: "24%" ,left:"26%", width:"10%"}} /></a>*/}
                  {/*<a href="/"><img src={"./slides/play.png"} alt="btn" name={16} className="main-button" style={{marginTop: "24%" ,left:"38%", width:"10%"}} /></a>*/}
                  {/*<a href="/"><img src={"./slides/play.png"} alt="btn" name={17} className="main-button" style={{marginTop: "24%" ,left:"50%", width:"10%"}} /></a>*/}
