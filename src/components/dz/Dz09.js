    ...
    render() {
        return (
            <div style={{width: "100%"}} >
                ...
                { this.state.slide === 5 ? <Karte slide={"k"} cards={KarteK} nextSlide={this.nextSlide}/> : null}
                ...
                { this.state.slide === 10 ? <Spajanje slide={"k"} game={PojmoviK} nextSlide={this.nextSlide}/> : null}
