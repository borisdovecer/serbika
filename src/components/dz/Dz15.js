    ...
    render() {
        return (
            <div style={{width: "100%"}} >
                ...
                { this.state.slide === 5 ? <Karte slide={"d"} cards={KarteD} nextSlide={this.nextSlide}/> : null}
                ...
                { this.state.slide === 9 ? <Spajanje slide={"d"} game={PojmoviD} nextSlide={this.nextSlide}/> : null}
