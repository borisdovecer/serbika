    ...
    render() {
        return (
            <div style={{width: "100%"}} >
                ...
                { this.state.slide === 5 ? <Karte slide={"z"} cards={KarteZ} nextSlide={this.nextSlide}/> : null}
                ...
                { this.state.slide === 9 ? <Spajanje slide={"z"} game={PojmoviZ} nextSlide={this.nextSlide}/> : null}
