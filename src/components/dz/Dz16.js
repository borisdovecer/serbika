    ...
    render() {
        return (
            <div style={{width: "100%"}} >
                ...
                { this.state.slide === 5 ? <Karte slide={"g"} cards={KarteG} nextSlide={this.nextSlide}/> : null}
                ...
                { this.state.slide === 9 ? <Spajanje slide={"g"} game={PojmoviG} nextSlide={this.nextSlide}/> : null}
