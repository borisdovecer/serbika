    ...
    render() {
        return (
            <div style={{width: "100%"}} >
                ...
                { this.state.slide === 5 ? <Karte slide={"zh"} cards={KarteZh} nextSlide={this.nextSlide}/> : null}
                ...
                { this.state.slide === 9 ? <Spajanje slide={"zh"} game={PojmoviZh} nextSlide={this.nextSlide}/> : null}
